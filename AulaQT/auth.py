...
from authClass import Autentica
...
class Ui_MainWindow(object):
    ...
    def checkfields(self):
        ...
        if not self.lineEdit_2.text():
            textPassword = "pass Empty"
        else:
            textPassword = ""

        if textPassword + textUser != "":
            text = textPassword + textUser
            showMessage(text)
        else:
            text = "Login OK"
            showMessage(text)
        ...
        print (email)
        print (senha)
        autenticado_check = Autentica(email, senha)
        stat1 = autenticado_check.esta_autenticado()
        if stat1 == True:
...
#minhas funcoes
        ...
        #close - erro
        self.pushButton_erro.clicked.connect(lambda: self.frame.hide())

        #inicia o fram erro fechado
        self.frame.hide()

        #login BT
       
        self.pushButton.clicked.connect(self.checkfields)
